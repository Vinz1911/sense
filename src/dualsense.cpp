...
namespace sense {
    DualSense::DualSense(const char* path): device_path_(path) {
        ...
        axis = { {AXIS_LEFT_THUMB_X, 0}, {AXIS_LEFT_THUMB_Y, 0}, {AXIS_LEFT_TRIGGER, 0}, {AXIS_RIGHT_THUMB_X, 0}, {AXIS_RIGHT_THUMB_Y, 0}, {AXIS_RIGHT_TRIGGER, 0}, {AXIS_D_PAD_LEFT_RIGHT, 0}, {AXIS_D_PAD_UP_DOWN, 0} };
    }
